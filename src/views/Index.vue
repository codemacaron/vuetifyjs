      ...
      .section
        .container
          .features.text-center
            .md-layout
              .md-layout-item.md-size-33.md-small-size-50.md-xsmall-size-100(v-for="i in 10")
                .info
                  .md-layout-item.md-size-100.mx-auto
                    img.img-raised.img-fluid(:src="teamImg1" alt="Thumbnail Image")
                  h4.info-title 모리 코튼 원피스
                  p 
                    | 잔잔한 패턴이 포인트인 반팔 원피스 입니다.
                    | 세련된 블루컬러에 적당한 길이감이
                    | 발랄하지만 소녀스러운 무드를 연출하게 한답니다.
      .section.text-center
        .container
          h2.title
            | Here is our team
